...
<img src="Images/Output/data_distribution plot.jpg" width="600" style="margin-right: 25px;">
 <h3>Heatmap</h3>
<img src="Images/Output/heatmap.jpg" width="400" style="margin-right: 25px;">
  <h3>Catboost (without addition feature)</h3>
<img src="Images/Output/catboost without addition feature.jpg" width="600" style="margin-right: 25px;">
</div>
